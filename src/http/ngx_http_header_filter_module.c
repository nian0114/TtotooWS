...
static u_char ngx_http_server_string[] = "X-Powered-By: TtotooWS" CRLF;
static u_char ngx_http_server_full_string[] = "X-Powered-By: " NGINX_VER CRLF;
static u_char ngx_http_server_build_string[] = "X-Powered-By: " NGINX_VER_BUILD CRLF;
